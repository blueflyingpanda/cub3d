...
/*   Updated: 2020/09/05 18:20:20 by lhelper          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_image *screen);
void			wall_or_sprite(t_index *id, t_data *img,\
t_image *screen);
...
int				check_symbol(t_data *img, char *line, t_map *cord,\
t_flags *flag);
...
# define DIST_TO_DRINK 300
# define DIST_TO_WALL 100
# define MAX_HP 5
